...
namespace ToupTek
{
    ...
    public class ToupCam : IDisposable
    {
        ...
        public enum eOPTION : uint
        {
            ...
            OPTION_TRIGGER         = 0x0b,    /* 0 = continuous mode, 1 = software trigger mode, 2 = external trigger mode, default value = 0 */
            ...
            OPTION_TECTARGET       = 0x0f     /* get or set the target temperature of the thermoelectric cooler, in degree Celsius */
        };
        ...
        */
        ...
        /* get the version of this dll, which is: 1.6.6454.20151115 */
